...
public class ProductosDAO{
	...
	/**
	 * Actualiza un {@link Producto} pasado por parámetro y actualiza el {@link DateTime} del atributo fecha de edición
	 * @param p {@link Producto}
	 * @return {@link Producto}
	 */
	public Producto update(Producto p) {
		p.setFechaEdicion();
		logger.log(Level.INFO, "Se ejecutó el método update() de la clase ProductosDAO");
